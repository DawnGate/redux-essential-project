...
export const handlers = [
  ...
  rest.post('/fakeApi/posts', function (req, res, ctx) {
    ...
    if (data.content === 'error') {
      return res(
        ...
        ctx.status(500),
        ctx.json('Server error saving post')
      )
    }
  ...
  rest.post('/fakeApi/posts/:postId/reactions', function (req, res, ctx) {
  ...
  rest.get('/fakeApi/notifications', function (req, res, ctx) {
  ...
  rest.get('/fakeApi/users', function (req, res, ctx) {
